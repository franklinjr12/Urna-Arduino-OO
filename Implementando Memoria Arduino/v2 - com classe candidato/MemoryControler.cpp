...
//****************************************************************
//Implementations of MemoryControlerArduino

char MemoryControlerArduino::read(int position){
    return EEPROM[position];
}

int MemoryControlerArduino::write(char letter, int position){
    EEPROM[position] = letter;
    return 0;
}

int MemoryControlerArduino::assign(Memory* mem){
    memoryAssigned = mem;
    return 0;
}
